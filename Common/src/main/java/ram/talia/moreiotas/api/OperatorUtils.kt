...
operator fun Vec3.times(mat: DoubleMatrix): DoubleMatrix = (this.asMatrix).mul(mat)
operator fun DoubleMatrix.times(vec: Vec3): DoubleMatrix = this.mul(vec.asMatrix)
operator fun DoubleMatrix.times(mat: DoubleMatrix): DoubleMatrix = this.mul(mat)
